...
export const COLUMNS: ColumnDef[] = [
  ...
  { key: "societa", label: "Società", short: "Società", description: "Società cliente per cui viene svolto il servizio.", weight: 6.3 },
  { key: "contatti", label: "Contatti", short: "Contatti", description: "Nome del passeggero o referente da contattare.", weight: 9.7 },
  { key: "telefono", label: "Telefono", short: "Telefono", description: "Numero di telefono del passeggero/referente.", weight: 6.2 },
  ...
  { key: "tserv", label: "T.Serv", short: "T.Serv", description: "Tipo di servizio: transfer (interno/regionale), disposizione oraria o tour.", weight: 5.2 },
  { key: "luogo_inizio", label: "Luogo inizio", short: "Luogo inizio", description: "Punto di partenza del servizio (indirizzo, aeroporto, hotel).", weight: 7 },
  { key: "itinerario", label: "Itinerario", short: "Itinerario", description: "Tappe intermedie o percorso descritto del servizio.", weight: 9.8 },
  ...
  { key: "veicolo", label: "Veicolo", short: "Veicolo", description: "Veicolo assegnato al servizio (tipo e targa).", weight: 4.3 },
  { key: "tp", label: "T.P", short: "T.P", description: "Tipo di pagamento (fattura, contanti, carta di credito, bonifico…).", weight: 3.1, align: "center" },
