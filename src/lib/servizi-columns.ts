...
export const COLUMNS: ColumnDef[] = [
  ...
  { key: "societa", label: "Società", short: "Società", description: "Società cliente per cui viene svolto il servizio.", weight: 4.6 },
  { key: "contatti", label: "Contatti", short: "Contatti", description: "Nome del passeggero o referente da contattare.", weight: 4.8 },
  { key: "telefono", label: "Telefono", short: "Telefono", description: "Numero di telefono del passeggero/referente.", weight: 2.5 },
  ...
  { key: "tserv", label: "T.Serv", short: "T.Serv", description: "Tipo di servizio: transfer (interno/regionale), disposizione oraria o tour.", weight: 1.9 },
  { key: "luogo_inizio", label: "Luogo inizio", short: "Luogo inizio", description: "Punto di partenza del servizio (indirizzo, aeroporto, hotel).", weight: 8.0 },
  { key: "itinerario", label: "Itinerario", short: "Itinerario", description: "Tappe intermedie o percorso descritto del servizio.", weight: 9.9 },
  { key: "luogo_fine", label: "Luogo fine", short: "Luogo fine", description: "Punto di arrivo del servizio.", weight: 9.4 },
  ...
  { key: "accessori", label: "Accessori", short: "Accessori", description: "Accessori richiesti (seggiolino, wifi, acqua, ecc.).", weight: 3.0 },
  { key: "veicolo", label: "Veicolo", short: "Veicolo", description: "Veicolo assegnato al servizio (tipo e targa).", weight: 1.1 },
  { key: "tp", label: "T.P", short: "T.P", description: "Tipo di pagamento (fattura, contanti, carta di credito, bonifico…).", weight: 1.2, align: "center" },
  ...
  { key: "codice", label: "Codice", short: "Codice", description: "Codice interno identificativo del servizio.", weight: 3.4 },
