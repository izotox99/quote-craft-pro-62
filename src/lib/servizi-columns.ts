...
export const COLUMNS: ColumnDef[] = [
  { key: "citta", label: "Città", short: "Città", description: "Città in cui si svolge il servizio.", weight: 2 },
  { key: "data", label: "Data", short: "Data", description: "Data e ora di inizio del servizio.", weight: 3 },
  { key: "societa", label: "Società", short: "Società", description: "Società cliente per cui viene svolto il servizio.", weight: 5 },
  ...
  { key: "np", label: "N.P", short: "N.P", description: "Numero di passeggeri.", weight: 1, align: "center" },
  { key: "nb", label: "N.B", short: "N.B", description: "Numero di bagagli.", weight: 1, align: "center" },
  ...
  { key: "luogo_inizio", label: "Luogo inizio", short: "L.Inizio", description: "Punto di partenza del servizio (indirizzo, aeroporto, hotel).", weight: 6 },
  { key: "itinerario", label: "Itinerario", short: "Itiner.", description: "Tappe intermedie o percorso descritto del servizio.", weight: 6 },
  { key: "luogo_fine", label: "Luogo fine", short: "L.Fine", description: "Punto di arrivo del servizio.", weight: 6 },
  ...
  { key: "tp", label: "T.P", short: "T.P", description: "Tipo di pagamento (fattura, contanti, carta di credito, bonifico…).", weight: 2, align: "left" },
  ...
  { key: "foglio", label: "Foglio", short: "Fog.", description: "Pulsante di stampa del foglio di servizio in PDF.", weight: 1, align: "center" },
